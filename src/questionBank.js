...
const RAW_THEMES = [
  ...
  },
  {
    ...
    questions: [
      ...
      qcm('Quelle est, environ, la vitesse de la lumière ?', ['300 km/s', '30 000 km/s', '300 000 km/s', '3 millions de km/s'], 2),
  ...
  },
  {
    ...
    questions: [
      ...
      qcm('Combien de litres de lait faut-il environ pour faire 1 kg de comté ?', ['2 litres', '5 litres', '12 litres', '30 litres'], 2),
